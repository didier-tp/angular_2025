...
/*
Ancienne version: avec BehaviorSubject de rxJs
Nouvelle version: avec signal
*/
...
export class ProduitService {
  ...
  private  sSeuilMaxi = signal<number>(100); //seuil (pour prixMaxi)

  public changerSeuil(nouveauSeuilMaxi : number){
    this.sSeuilMaxi.set(nouveauSeuilMaxi);
    //l'appel à .set(90_ou_80)
    //va provoquer le rédéclenchement de tous les écoutes/réaffichages
    //(dans tous les composants)
  }

  /*
  dans un composant angular utilisant ce service on aura  
  produitService.seuilMaxi() et éventuels effect ou computed
  */

  //public get seuilMaxi() : WritableSignal<number>{
  public get seuilMaxi() : Signal<number>{
    return this.sSeuilMaxi;
  }
